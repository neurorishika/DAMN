...
sns.heatmap(overall_state[::100,order].T,xticklabels=1000,yticklabels=15)
...
y = overall_state[50000:150000,:90].mean(axis=1)
Y = np.fft.fft(y)
...
plt.savefig("fourier.png",transparent=True)
