...
r1_sgaba = [0.53]*n_syn_sgaba         # r1 for sGABA Synapse
r2_sgaba = [0.0013*5]*n_syn_sgaba      # r2 for sGABA Synapse
r3_sgaba = [0.098]*n_syn_sgaba         # r3 for sGABA Synapse
...
G_sgaba = [2.0]*p_n+[0.0]*l_n      # sGABA Conductance
...
PN_scale = 25/current_input[:p_n,:].max()/60 # PN Scaling Factor
