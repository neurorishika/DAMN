...
data['f_sharp'] = np.zeros(data['ORN_types'])#np.random.choice([1,0],size=data['ORN_types'],p=[0.5,1-0.5])
data['adaptation_extent'] = np.ones(data['ORN_types'])#np.random.uniform(0.5,1,size=data['ORN_types'])
...
data['max_pn_current'] = 15
data['max_ln_current'] = 10
