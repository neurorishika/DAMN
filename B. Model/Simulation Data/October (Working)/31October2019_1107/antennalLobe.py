...
g_ach = [0.35*0.0]*p_n+[0.3]*l_n         # Ach Conductance
...
g_fgaba = [1.3*1.5]*p_n+[0.8]*l_n        # fGABA Conductance
...
r2_sgaba = [0.0013*10]*n_syn_sgaba      # r2 for sGABA Synapse
...
G_sgaba = [0.15]*p_n+[0.0]*l_n      # sGABA Conductance
...
PN_scale = 35/current_input[:p_n,:].max() # PN Scaling Factor
LN_scale = 4/current_input[p_n:,:].max() # LN Scaling Factor
